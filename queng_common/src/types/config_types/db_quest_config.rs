...
impl QuestDBConfig {
    ...
    ///
    /// let config = QuestDBConfig::new("localhost".to_string());
    /// ```
    ...
    /// use common::prelude::QuestDBConfig;
    ///
    /// let config = QuestDBConfig::new_with_pg_config(
...
impl QuestDBConfig {
    ...
    /// use common::prelude::QuestDBConfig;
    ///
    /// let config = QuestDBConfig::QuestDBConfig("localhost".into());
...
impl QuestDBConfig {
    ...
    /// use common::prelude::QuestDBConfig;
    ///
    /// let config = QuestDBConfig::new("localhost".into());
...
impl Display for QuestDBConfig {
